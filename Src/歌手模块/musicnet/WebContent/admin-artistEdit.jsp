				...
				<form onsubmit="return editCheck();" action="admin-artistEdit_deal.jsp">
					<div class="n-base f-cb">
						<div class="frm m-frm">
							...
							<div class="itm">
								歌手姓名：<input type="text" value="<%=artistName%>" class="u-txt txt" id="artistName"  name="artistName" maxlength="30">
							</div>
							...
							<div class="itm">
								歌手图片：<input type="text" value="<%=imgURL%>" class="u-txt txt" id="imgURL" name="imgURL" maxlength="30">
							</div>

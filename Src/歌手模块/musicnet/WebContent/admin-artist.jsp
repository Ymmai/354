...
<%
	...
	sql.append("select * from tb_artist order by id desc ");
		...
		<div class="g-bd" style="margin-top:50px">
			<div class="g-wrap" id="baseBox">
				...
				<ul class="m-tabs f-cb">
					<li class="fst">
						<a href="admin-artist.jsp" class="z-slt"><em>歌手</em> </a>
					</li>
					<li>
						<a href="admin-song.jsp"><em>歌曲</em> </a>
					</li>
				</ul>
				<div class="g-wrap p-prf">
					<div class="n-bind f-cb j-flag">
						<p class="delete">
							<a target="contentFrame" href="admin-artistAdd.jsp" class="btn"><i>新增歌手</i>
							</a>
						</p>
					</div>
					...
					<div class="u-title u-title-1 f-cb m-record-title" id="rHeader">
						<h3>
							<span class="f-ff2 s-fc3">歌手列表</span>
						</h3>
								...
								<table class="m-table m-table-rank">
									...
									<tbody>
										...
										<tr>
											...
											<td class="">
												<a href="admin-artistEdit.jsp?id=<%=ID%>">修改</a>
												<a href="admin-artistDel_deal.jsp?delid=<%=ID%>">删除</a>
											</td>
										</tr>
										<%
											try {
									...
									<tr>
										<td height="24" align="right">
											...
											<%
												if (Page > 1) {
											%>
											<a href="admin-artist.jsp?Page=1">第一页</a>
											<a href="admin-artist.jsp?Page=<%=Page - 1%>">上一页</a>
											<%
												}
												if (Page < maxPage) {
											%>
											<a href="admin-artist.jsp?Page=<%=Page + 1%>">下一页</a>
											<a href="admin-artist.jsp?Page=<%=maxPage%>">最后一页&nbsp;</a>
											<%
												}
											%>
										</td>
